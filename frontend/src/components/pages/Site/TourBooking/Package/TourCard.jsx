...
const TourCard = ({ tour, isExpanded, onToggle }) => {


  return (
    <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 flex flex-col transition-all duration-300">
      ...
      <div className="p-8 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex gap-4">
          ...
          <button
            onClick={onToggle}
            className={`flex-1 flex items-center justify-center gap-2 border-2 py-4 rounded-2xl font-bold transition-all ${isExpanded
