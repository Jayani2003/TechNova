    ...
    <section className="relative h-[70vh] flex items-center justify-center bg-[#005f73] text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <span className="px-4 py-2 bg-[#94d2bd] text-[#001219] rounded-full font-semibold">Package Tours</span>
          <span className="px-4 py-2 bg-[#94d2bd] text-[#001219] rounded-full font-semibold">Customized Tours</span>
